...
export const webRoutes = [
  ...
  { method: "GET", path: "/adminanalytics", config: adminController.adminAnalytics },
  ...
  { method: "POST", path: "/profile/updateuser", config: accountsController.updateUser },
  { method: "GET", path: "/profile/changepassword", config: accountsController.showChangePassword },
  { method: "GET", path: "/dashboard/{id}", config: poiController.showEditPOI },
  { method: "POST", path: "/dashboard/{id}", config: poiController.editPOI },
